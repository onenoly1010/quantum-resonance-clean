...
def test_create_patch_invalid_analysis(patch_agent):
    ...
    patch_content = PatchContent(
        files_modified=["test.py"], changes={}, dependencies=[], configuration={}
    )
...
def test_deploy_patch_not_tested(patch_agent):
    ...
    patch_content = PatchContent(
        files_modified=["src/main.py"], changes={}, dependencies=[], configuration={}
    )
...
def test_rollback_config_creation(patch_agent):
    ...
    patch_content = {"files_modified": ["test.py"], "changes": {}}
...
def test_severity_calculation_critical(patch_agent):
    ...
    findings = {
        "issues": [{"severity": "critical", "description": "Critical issue"}],
        "inefficiencies": [],
        "opportunities": [],
    }
...
def test_severity_calculation_high(patch_agent):
    ...
    findings = {
        "issues": [{"severity": "high", "description": "High issue"}],
        "inefficiencies": [],
        "opportunities": [],
    }
...
def test_severity_calculation_medium(patch_agent):
    ...
    findings = {
        "issues": [{"severity": "medium", "description": "Medium issue"}],
        "inefficiencies": [],
        "opportunities": [],
    }
...
def test_severity_calculation_low(patch_agent):
    ...
    findings = {
        "issues": [],
        "inefficiencies": [{"description": "Inefficiency"}],
        "opportunities": [],
    }
