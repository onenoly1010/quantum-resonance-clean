...
from src.models.models import LedgerTransaction, LogicalAccount, ReconciliationLog
...
class ReconciliationService:
        ...
        result = (
            db.query(
                func.sum(
                    case(
                        (
                            LedgerTransaction.transaction_type == "credit",
    ...
    def create_reconciliation(
        ...
        account = (
            ...
            .filter(LogicalAccount.id == reconciliation_data.account_id)
            .first()
        )
    ...
    def get_variance_reconciliations(
        db: Session, account_id: Optional[UUID] = None
